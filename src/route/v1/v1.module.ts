...
import ConversationModule from '@features/f4-conversations/conversation.module';
import SuggestionModule from '@features/f1-suggestions/suggestion.module';
...
const routes: Routes = [
  {
    ...
    children: [
      ...
      // Features
      { path: '/suggestions', module: SuggestionModule },
      { path: '/sub-suggestions', module: SubSuggestionModule },
